 ...
 *
 * Or run the exported JSON through the Supabase SQL editor / dashboard.
 */
...
// Output as JSON for manual import or use with Supabase client
console.log(JSON.stringify(inventory, null, 2));
console.log(`\nTotal bottles: ${inventory.length}`);
